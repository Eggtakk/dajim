...
export default function TrackingPage() {
  ...
  const report = getTrackingReport(goal);
  const segments = Array.from({ length: report.totalCycles }, (_, i) => {
    if (i < report.cycleIndex - 1) return "done";
    if (i === report.cycleIndex - 1) return "now";
    return "";
  });
    ...
    <>
      ...
      <div>
        ...
        <div className="chart-wrap" style={{ marginTop: 14 }}>
          ...
          <DualSparkline goalSeries={report.goalSeries} actualSeries={report.actualSeries} />
